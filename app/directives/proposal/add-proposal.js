angular.module('proposal')
    .directive("proposalform", ['proposalService',proposalform]);

function proposalform(proposalService) {
    return {
        restrict: "E",
        scope: false,
        ...
        controller: ['$scope','$state','$rootScope','$stateParams', function($scope,$state,$rootScope,$stateParams) {
        	 $scope.bvalue = 'Create';
        	 $scope.title = 'Create';
        	if($stateParams.id){
